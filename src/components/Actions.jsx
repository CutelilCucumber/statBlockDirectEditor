        ...
        <div className="editContainer">
            <fieldset className="editAction">
                ...
                <div className="btnContainer">
                        ...
                        <img className="btn delete" src="/assets/buttons/delete.svg" tabIndex='0'
            ...
            <div className="actionNav">
                <img className="btn" src="/assets/buttons/arrow-up.svg" tabIndex='0'
                ...
                <img className="btn" src="/assets/buttons/copy.svg" tabIndex='0'
                ...
                <img className="btn" src="/assets/buttons/arrow-down.svg" tabIndex='0'
