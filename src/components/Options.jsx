    ...
    return (
        <header>
            ...
            <div className="options">
                <img  tabIndex='0' src='src/assets/buttons/save.svg' title="Save to bestiary" className={changeCount < 1 ? "btn option saved" : "btn option"}
...
function Bestiary({editor, monList}){
    ...
    return(
        <>
        {isEditing ? (<>
            <img src={'src/assets/buttons/book-open.svg'} className="btn option"
            ...
            <div className="monList">
                ...
                onKeyDown={(e) => {if(e.key === 'Enter') editor.selectMonster(mon)}}>
                            {mon.name}</h4>
                        <img tabIndex='0' className="listBtn btn" title='Clone monster' src="src/assets/buttons/copy.svg" 
                        onClick={() => editor.addClone(mon)}
                onKeyDown={(e) => {if(e.key === 'Enter') editor.addClone(mon)}}/>
                        <img tabIndex='0' className="btn" title='Remove from Bestiary' src="src/assets/buttons/delete.svg" 
            ...
            <img src={'src/assets/buttons/book.svg'} className="btn option"
...
function SelectImg({editor}){
    ...
    return (
        ...
        {isEditing? (
            ...
            <img tabIndex='0' className="btn" src="src/assets/buttons/save.svg" onClick={() => {
                    setTempSrc('');
                    editor.setEdit(null);
                    editor.handleChange('imgSrc', tempSrc)}}
            ...
            <img tabIndex='0' className="btn" src="src/assets/buttons/cancel.svg" onClick={() => editor.setEdit(null)}
                onKeyDown={(e) => {if(e.key === 'Enter') editor.setEdit(null)}}/>
            </div>
        ) : (
            <img tabIndex='0' src={'src/assets/buttons/image.svg'} className="btn option listBtn" title="Select image"
                onClick={() => {
                    setTempSrc('');
